...
public class AimCommand extends Command 
{
    ...
    @Override public void execute() 
    {
        ...
        try 
        {
            ...
            final double velocityX = xPidController.calculate(fiducial.distToRobot, 1) * TunerConstants.MaxSpeed  -0.5;
            final double velocityY = yPidController.calculate(fiducial.distToRobot, 1) * TunerConstants.MaxSpeed  -0.5;
            ...
            SmartDashboard.putNumber("xPidController", velocityY);
            drivetrain.setControl(alignRequest.withRotationalRate(rotationalRate).withVelocityX(velocityX).withVelocityY(velocityY));
